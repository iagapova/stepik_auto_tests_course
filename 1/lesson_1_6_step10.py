...
try:
    ...
    #     By.CSS_SELECTOR, '[class="form-control first"][placeholder="Input your first name"]')
    # input1.send_keys("Ivan")
    # input2 = browser.find_element(
    #     By.CSS_SELECTOR, '[class="form-control second"][placeholder="Input your last name"]')
    # input2.send_keys("Petrov")
    # input3 = browser.find_element(
    #     By.CSS_SELECTOR, '[class="form-control third"][placeholder="Input your email"]')
